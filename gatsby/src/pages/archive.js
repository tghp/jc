...
export default function ArchivePage({ data }) {
  ...
  const onScroll = () => {
    const archiveSectionWindowTop =
      archiveSection.current.getBoundingClientRect().top;
    const mostRecentLink = sideBar.current.querySelector(
      '.archive-posts__posts-sidebar-link:first-child',
    );
    const archiveLink = sideBar.current.querySelector(
      '.archive-posts__posts-sidebar-link:last-child',
    );
        ...
        <div className="archive-posts">
          <div className="archive-posts__header">
            <div className="archive-posts__header-inner">
              ...
              <h1 className="archive-posts__header-title">All Writing</h1>
            </div>
          </div>
          <div className="archive-posts__posts">
            <div className="archive-posts__posts-sidebar" ref={sideBar}>
              <Link
                ...
                className="archive-posts__posts-sidebar-link link-active"
              >
                Most recent
              </Link>
              <Link
                to={'#archived-posts'}
                className="archive-posts__posts-sidebar-link"
              >
                Archive
              </Link>
            </div>
            ...
            <div
              className="archive-posts__posts-archive"
              id="archived-posts"
              ref={archiveSection}
            >
