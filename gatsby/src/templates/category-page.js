...
export default function CategoryPage({ data }) {
  const { name, tghpjcCategoryContent: content } = data.wpCategory;
        ...
        <div className="archive-posts">
          <div className="archive-posts__header">
            <div className="archive-posts__header-inner">
              ...
              <h1 className="archive-posts__header-title">{name}</h1>
            </div>
          </div>
          <div className="archive-posts__posts">
            <div className="archive-posts__posts-sidebar"></div>
            {content && (
              <div
                className="archive-posts__posts-cat-excerpt"
