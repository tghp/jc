...
/*!*****************************!*\
  !*** ./assets/js/fields.js ***!
  \*****************************/
/*! exports provided: MetaBoxes */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MetaBoxes", function() { return MetaBoxes; });
const {
  useState,
  useEffect
} = wp.element;
...
const MetaBoxes = ({
  ...
  useEffect(() => {
    const getMetaBoxes = async () => {
      const metaBoxes = await fetchMetaBoxes(objectType);
      setMetaBoxes(metaBoxes);
    };

    getMetaBoxes();
  }, []);
  const type = 'setting' === objectType ? 'site' : objectType;
  return metaBoxes.map((metaBox, key) => /*#__PURE__*/React.createElement(MetaBox, {
    key: key,
    metaBox: metaBox,
    type: type
  }));
...
const MetaBox = ({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "mbv-inserter__heading"
  }, title), /*#__PURE__*/React.createElement(Fields, {
    fields: fields,
    type: type,
    subtype: type === 'site' ? metaBox.settings_pages[0] : '',
    parent: ""
  }));
};
...
const Fields = ({
  ...
  const noValueTypes = ['button', 'custom_html', 'divider', 'heading'];
  fields = fields.filter(field => !noValueTypes.includes(field.type));
  return /*#__PURE__*/React.createElement("ul", {
    className: "mbv-inserter__fields"
  }, fields.map((field, key) => /*#__PURE__*/React.createElement(Field, {
    key: key,
    field: field,
    type: type,
    subtype: subtype,
...
const Field = ({
  ...
  const modal = types[field.type],
        className = field.fields ? ' mbv-has-fields' : '',
        title = field.clone ? i18n.cloneable : '';
  const label = /*#__PURE__*/React.createElement("label", null, field.fields ? /*#__PURE__*/React.createElement("button", {
    className: "mbv-group-toggle",
    onClick: () => setOpen(!open)
  }, /*#__PURE__*/React.createElement("span", {
    className: `dashicons dashicons-arrow-${open ? 'up' : 'down'}`
  })) : '', field.name || field.id, field.clone ? /*#__PURE__*/React.createElement("span", {
    className: "dashicons dashicons-controls-repeat"
  }) : '');
  const children = field.fields && open ? /*#__PURE__*/React.createElement(Fields, {
    fields: field.fields,
    type: type,
    subtype: subtype,
    parent: field.clone ? 'clone' : parent ? `${parent}.${field.id}` : field.id
  }) : '';
  return modal ? /*#__PURE__*/React.createElement("li", {
    title: title,
    className: `mbv-inserter__field mbv-modal-trigger${className}`,
    "data-type": type,
    "data-subtype": subtype,
    "data-modal": `field-${modal}`,
    "data-field": JSON.stringify(field),
    "data-parent": parent
  }, label, " ", children) : /*#__PURE__*/React.createElement("li", {
    title: title,
    className: `mbv-inserter__field${className}`,
    "data-type": type,
    "data-subtype": subtype,
    "data-field": JSON.stringify(field),
    "data-parent": parent
...
const fetchMetaBoxes = async objectType => {
  let url = `${i18n.rest_url}mbv/meta-boxes`;
  const query = `object_type=${objectType}`;
  url += i18n.rest_url.includes('?') ? `&${query}` : `?${query}`;
  ...
  return Object.values(response).map(metaBox => metaBox.meta_box).filter(isUserDefined).map(normalizeMetaBoxFields);
};

const isUserDefined = metaBox => {
  const builtIn = [// MB Custom Post Type.
  'mb-cpt-basic-settings', 'mb-cpt-buttons', 'mb-cpt-label-settings', 'mb-cpt-advanced-settings', 'mb-cpt-supports', 'mb-cpt-taxonomies', 'mb-cpt-generate-code', // MB Custom Taxonomy.
  'ct-basic-settings', 'ct-buttons', 'mb-ct-label-settings', 'mb-ct-advanced-settings', 'mb-ct-generate-code', 'mb-ct-assign', // MB Views.
  'mbv-template-editor', 'mbv-settings', // MB User Profile.
  'rwmb-user-register', 'rwmb-user-login', 'rwmb-user-lost-password', 'rwmb-user-reset-password', 'rwmb-user-info'];
  const isRelationship = /(_relationships_from|_relationships_to)$/.test(metaBox.id);
  return !builtIn.includes(metaBox.id) && !isRelationship;
};

const normalizeMetaBoxFields = metaBox => {
  if (!Array.isArray(metaBox.fields)) {
    metaBox.fields = Object.values(metaBox.fields);
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modals_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modals.js */ "./assets/js/modals.js");
/* harmony import */ var _panels_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./panels.js */ "./assets/js/panels.js");
/* harmony import */ var _panels_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_panels_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _tabs_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./tabs.js */ "./assets/js/tabs.js");
/* harmony import */ var _fields_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./fields.js */ "./assets/js/fields.js");
/* harmony import */ var _relationships_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./relationships.js */ "./assets/js/relationships.js");
/* harmony import */ var _views_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./views.js */ "./assets/js/views.js");
/* harmony import */ var _search_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./search.js */ "./assets/js/search.js");
/* harmony import */ var _inserter_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./inserter.js */ "./assets/js/inserter.js");
/* harmony import */ var _location_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./location.js */ "./assets/js/location.js");
...
let jsSettings = $.extend(true, {}, wp.codeEditor.defaultSettings);
jsSettings.codemirror.mode = 'javascript';
jsSettings.codemirror.theme = 'oceanic-next';
const jsEditor = wp.codeEditor.initialize('mbv-post-content-filtered', jsSettings).codemirror;
jsEditor.setSize(null, '480px');
const editorTabs = new _tabs_js__WEBPACK_IMPORTED_MODULE_2__["default"]('.mbv-editors', el => {
  if (el.dataset.tab === 'template-editor') {
    _inserter_js__WEBPACK_IMPORTED_MODULE_7__["editor"].refresh();
    _inserter_js__WEBPACK_IMPORTED_MODULE_7__["editor"].focus();
  }

  if (el.dataset.tab === 'css-editor') {
    cssEditor.refresh();
    cssEditor.focus();
  }

  if (el.dataset.tab === 'js-editor') {
    jsEditor.refresh();
    jsEditor.focus();
  }
});
editorTabs.bindEvents();
const fieldTabs = new _tabs_js__WEBPACK_IMPORTED_MODULE_2__["default"]('.mbv-panel');
fieldTabs.bindEvents();
render( /*#__PURE__*/React.createElement(_fields_js__WEBPACK_IMPORTED_MODULE_3__["MetaBoxes"], {
  objectType: "post"
}), document.querySelector('#mbv-post-fields'));
render( /*#__PURE__*/React.createElement(_fields_js__WEBPACK_IMPORTED_MODULE_3__["MetaBoxes"], {
  objectType: "term"
}), document.querySelector('#mbv-term-fields'));
render( /*#__PURE__*/React.createElement(_fields_js__WEBPACK_IMPORTED_MODULE_3__["MetaBoxes"], {
  objectType: "user"
}), document.querySelector('#mbv-user-fields'));
render( /*#__PURE__*/React.createElement(_fields_js__WEBPACK_IMPORTED_MODULE_3__["MetaBoxes"], {
  objectType: "setting"
}), document.querySelector('#mbv-site-fields'));
render( /*#__PURE__*/React.createElement(_location_js__WEBPACK_IMPORTED_MODULE_8__["default"], {
  base: "archive_locations",
  locations: MBViews.archiveLocations,
  groups: MBViews.archiveRules
}), document.querySelector('#mbv-archive-locations'));
render( /*#__PURE__*/React.createElement(_location_js__WEBPACK_IMPORTED_MODULE_8__["default"], {
  base: "singular_locations",
  locations: MBViews.singularLocations,
  groups: MBViews.singularRules
}), document.querySelector('#mbv-singular-locations'));
render( /*#__PURE__*/React.createElement(_relationships_js__WEBPACK_IMPORTED_MODULE_4__["Relationships"], null), document.querySelector('#mbv-relationships-fields'));
render( /*#__PURE__*/React.createElement(_views_js__WEBPACK_IMPORTED_MODULE_5__["Views"], null), document.querySelector('#mbv-view-fields'));

/***/ }),

/***/ "./assets/js/inserter.js":
/*!*******************************!*\
  !*** ./assets/js/inserter.js ***!
  \*******************************/
/*! exports provided: hasSpecialChars, insertTextAtCursor, editor */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hasSpecialChars", function() { return hasSpecialChars; });
...
/* harmony import */ var _modals_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modals.js */ "./assets/js/modals.js");
/* harmony import */ var _src_Fields_Avatar_inserter_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../src/Fields/Avatar/inserter.js */ "./src/Fields/Avatar/inserter.js");
/* harmony import */ var _src_Fields_Background_inserter_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../src/Fields/Background/inserter.js */ "./src/Fields/Background/inserter.js");
/* harmony import */ var _src_Fields_Checkbox_inserter_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../src/Fields/Checkbox/inserter.js */ "./src/Fields/Checkbox/inserter.js");
/* harmony import */ var _src_Fields_Choice_inserter_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../src/Fields/Choice/inserter.js */ "./src/Fields/Choice/inserter.js");
/* harmony import */ var _src_Fields_Date_inserter_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../src/Fields/Date/inserter.js */ "./src/Fields/Date/inserter.js");
/* harmony import */ var _src_Fields_File_inserter_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../src/Fields/File/inserter.js */ "./src/Fields/File/inserter.js");
/* harmony import */ var _src_Fields_Image_inserter_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../src/Fields/Image/inserter.js */ "./src/Fields/Image/inserter.js");
/* harmony import */ var _src_Fields_KeyValue_inserter_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../src/Fields/KeyValue/inserter.js */ "./src/Fields/KeyValue/inserter.js");
/* harmony import */ var _src_Fields_Map_inserter_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../src/Fields/Map/inserter.js */ "./src/Fields/Map/inserter.js");
/* harmony import */ var _src_Fields_Oembed_inserter_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../src/Fields/Oembed/inserter.js */ "./src/Fields/Oembed/inserter.js");
/* harmony import */ var _src_Fields_Pagination_inserter_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../src/Fields/Pagination/inserter.js */ "./src/Fields/Pagination/inserter.js");
/* harmony import */ var _src_Fields_Post_inserter_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../src/Fields/Post/inserter.js */ "./src/Fields/Post/inserter.js");
/* harmony import */ var _src_Fields_Sidebar_inserter_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../src/Fields/Sidebar/inserter.js */ "./src/Fields/Sidebar/inserter.js");
/* harmony import */ var _src_Fields_Taxonomy_inserter_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../src/Fields/Taxonomy/inserter.js */ "./src/Fields/Taxonomy/inserter.js");
/* harmony import */ var _src_Fields_Terms_inserter_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../src/Fields/Terms/inserter.js */ "./src/Fields/Terms/inserter.js");
/* harmony import */ var _src_Fields_User_inserter_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../src/Fields/User/inserter.js */ "./src/Fields/User/inserter.js");
/* harmony import */ var _src_Fields_Video_inserter_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../src/Fields/Video/inserter.js */ "./src/Fields/Video/inserter.js");
...
const $ = jQuery;
let editorSettings = $.extend(true, {}, wp.codeEditor.defaultSettings);
editorSettings.codemirror.theme = 'oceanic-next';
const editor = wp.codeEditor.initialize('mbv-post-content', editorSettings).codemirror;
...
function insertLoop() {
  let text = '';
  text += '{% for post in query.posts %}';
  text += '\n\tINSERT POST FIELDS HERE';
  text += '\n{% endfor %}';
  insertTextAtCursor(text);
}

function insertPostNavigation() {
  let text = '{{ mb.get_the_post_navigation() }}';
  insertTextAtCursor(text);
}

function insertPostComments() {
  let text = '{{ mb.post_comments() }}';
  insertTextAtCursor(text);
}

function insertSimpleField(e) {
  const el = e.target.parentNode;

  if (!el.classList.contains('mbv-inserter__field')) {
    return;
  }

  if (el.classList.contains('mbv-insert-query-loop')) {
    insertLoop();
    return;
  }

  if (el.classList.contains('mbv-insert-post-navigation')) {
    insertPostNavigation();
    return;
  }

  if (el.classList.contains('mbv-insert-post-comments')) {
    insertPostComments();
    return;
  }
  ...
  const subtype = el.dataset.subtype; // Store current field settings for next modals.

  currentField = JSON.parse(el.dataset.field); // Store current user settings.

  currentUser = document.querySelector('#mbv-user').value;
  /*
   * Move field to proper namespace (by object type).
   * Extract field when field ID contains special characters.
   */

  let group = 'user' === type ? currentUser : type; // For settings pages, subtype = settings page ID.

  if (subtype) {
    group = `${type}.${subtype}`;

    if (hasSpecialChars(subtype)) {
      before += `{% set group = attribute( ${type}, '${subtype}' ) %}\n`;
      group = 'group';
    }
  } // If a sub-field of a group, data-parent holds the group's ID.


  if (el.dataset.parent) {
    group = /^clone/.test(el.dataset.parent) ? el.dataset.parent : `${group}.${el.dataset.parent}`;
  }

  if (hasSpecialChars(currentField.id)) {
    before += `{% set field = attribute( ${group}, '${currentField.id}' ) %}\n`;
    currentField.id = 'field';
  } else {
    currentField.id = `${group}.${currentField.id}`;
  } // Trigger next modal for advanced settings.


  if (el.classList.contains('mbv-modal-trigger')) {
    return;
  }
  ...
  let {
    ...
    append,
    indents
  } = getPrependAppendTexts(currentField); // Get insert text.

  let text = `{{ ${currentField.id} }}`;

  switch (currentField.type) {
    case 'key_value':
      text = Object(_src_Fields_KeyValue_inserter_js__WEBPACK_IMPORTED_MODULE_8__["default"])(null, currentField);
      break;

    case 'group':
      text = 'INSERT SUB-FIELDS HERE';
      break;
  }
  ...
  insertTextAtCursor(`${before}${prepend}${indents}${text}${append}`);
}

function insertComplexField(e) {
  const el = e.target;

  if (!el.classList.contains('mbv-insert')) {
    return;
  }
  ...
  let {
    ...
    append,
    indents
  } = getPrependAppendTexts(currentField);
  const modal = el.closest('.mbv-modal');
  let text = '';

  switch (modal.dataset.type) {
    case 'avatar':
      text = Object(_src_Fields_Avatar_inserter_js__WEBPACK_IMPORTED_MODULE_1__["default"])(modal, currentUser, indents);
      break;

    case 'background':
      text = Object(_src_Fields_Background_inserter_js__WEBPACK_IMPORTED_MODULE_2__["default"])(modal, currentField, indents);
      break;

    case 'checkbox':
      text = Object(_src_Fields_Checkbox_inserter_js__WEBPACK_IMPORTED_MODULE_3__["default"])(modal, currentField, indents);
      break;

    case 'choice':
      text = Object(_src_Fields_Choice_inserter_js__WEBPACK_IMPORTED_MODULE_4__["default"])(modal, currentField, indents);
      break;

    case 'file':
      text = Object(_src_Fields_File_inserter_js__WEBPACK_IMPORTED_MODULE_6__["default"])(modal, currentField, indents);
      break;

    case 'date':
      text = Object(_src_Fields_Date_inserter_js__WEBPACK_IMPORTED_MODULE_5__["default"])(modal, currentField, indents);
      break;

    case 'image':
      text = Object(_src_Fields_Image_inserter_js__WEBPACK_IMPORTED_MODULE_7__["default"])(modal, currentField, indents);
      break;

    case 'map':
      text = Object(_src_Fields_Map_inserter_js__WEBPACK_IMPORTED_MODULE_9__["default"])(modal, currentField, indents);
      break;

    case 'oembed':
      text = Object(_src_Fields_Oembed_inserter_js__WEBPACK_IMPORTED_MODULE_10__["default"])(modal, currentField, indents);
      break;

    case 'pagination':
      text = Object(_src_Fields_Pagination_inserter_js__WEBPACK_IMPORTED_MODULE_11__["default"])(modal, currentField, indents);
      break;

    case 'post':
      text = Object(_src_Fields_Post_inserter_js__WEBPACK_IMPORTED_MODULE_12__["default"])(modal, currentField, indents);
      break;

    case 'sidebar':
      text = Object(_src_Fields_Sidebar_inserter_js__WEBPACK_IMPORTED_MODULE_13__["default"])(modal, currentField, indents);
      break;

    case 'taxonomy':
      text = Object(_src_Fields_Taxonomy_inserter_js__WEBPACK_IMPORTED_MODULE_14__["default"])(modal, currentField, indents);
      break;

    case 'terms':
      text = Object(_src_Fields_Terms_inserter_js__WEBPACK_IMPORTED_MODULE_15__["default"])(modal, currentField, indents);
      break;

    case 'user':
      text = Object(_src_Fields_User_inserter_js__WEBPACK_IMPORTED_MODULE_16__["default"])(modal, currentField, indents);
      break;

    case 'video':
      text = Object(_src_Fields_Video_inserter_js__WEBPACK_IMPORTED_MODULE_17__["default"])(modal, currentField, indents);
      break;
  }
  ...
  insertTextAtCursor(`${before}${prepend}${indents}${text}${append}`);
  _modals_js__WEBPACK_IMPORTED_MODULE_0__["default"].closeCurrent(el);
}

function getPrependAppendTexts(field) {
  let prepend = '',
      append = '',
      indents = ''; // Fieldset text renders value in a table.
  ...
  if (field.clone) {
    prepend += `{% for clone in ${currentField.id} %}`;
    currentField.id = 'clone'; // Change field ID to keep the same syntax in single field template.

    append += `\n{% endfor %}`;
    indents = `\t`;
  }

  if (field.multiple && 'key_value' !== field.type) {
    prepend += `\n${indents}{% for item in ${currentField.id} %}`;
    currentField.id = 'item'; // Change field ID to keep the same syntax in single field template.

    let itemAppend = '';
    itemAppend += `\n${indents}{% endfor %}`;
    append = `${itemAppend}${append}`;
    indents += `\t`;
  }
...
const hasSpecialChars = string => !/^[a-zA-Z][^-]*$/.test(string);
const insertTextAtCursor = text => {
  const doc = editor.getDoc();
  doc.replaceRange(text, doc.getCursor());
  editor.focus();
};
 // Use window instead of document to allow React components to define their insert handler. See https://github.com/facebook/react/issues/4335.

window.addEventListener('click', insertSimpleField);
window.addEventListener('click', insertComplexField);
...
/* harmony import */ var react_select_async__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react-select/async */ "./node_modules/react-select/async/dist/react-select.browser.esm.js");
...
const Groups = props => {
  ...
  */
  ...
  const removeGroup = id => setGroups(prevGroups => {
    let newGroups = { ...prevGroups
    };
    delete newGroups[id];
    return newGroups;
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, Object.entries(groups).map(([groupId, group]) => /*#__PURE__*/React.createElement(Group, {
    key: groupId,
    group: group,
    removeGroup: removeGroup,
    locations: props.locations,
    base: `${props.base}[${groupId}]`
  })), /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "button mbv-add-group",
    onClick: addGroup
  }, i18n.text.addGroup));
};
...
const Group = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "mbv-group"
  }, Object.entries(rules).map(([ruleId, rule]) => /*#__PURE__*/React.createElement(Rule, {
    key: ruleId,
    rule: rule,
    ruleId: ruleId,
    locations: locations,
...
const Rule = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    key: value,
    value: value
  }, label))))), // Using an unused "key" prop for AsyncSelect forces rerendering, which makes the loadOptions callback work.
  hasValue && /*#__PURE__*/React.createElement(react_select_async__WEBPACK_IMPORTED_MODULE_0__["default"], {
    className: "mbv-rule__value",
    ...
    type: "button",
    className: "button mbv-rule__add",
    onClick: addRule
  }, i18n.text.or), /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "mbv-rule__remove",
...
let apiCache = {};
const request = async (apiName, params = {}, method = 'GET', cache = true) => {
  ...
  let url = `${i18n.rest_url}mbv/location/${apiName}`;
...
document.addEventListener('click', Modals.clickHandle);
...
const panels = [...document.querySelectorAll('.mbv-panel')];
const Panels = {
  clickHandle: e => {
    const el = e.target;

    if (el.classList.contains('mbv-panel-trigger')) {
      e.preventDefault();
      Panels.toggle(el.dataset.panel);
    }

    if (el.classList.contains('mbv-panel__close')) {
      e.preventDefault();
      Panels.closeCurrent(el);
    }
  },
  closeCurrent: el => el.closest('.mbv-panel').classList.remove('mbv-is-open'),
  toggle: name => panels.find(panel => panel.dataset.panel === name).classList.toggle('mbv-is-open')
};
document.addEventListener('click', Panels.clickHandle);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return trimParams; });
function trimParams(selectors) {
  let params = selectors.map(selector => document.querySelector(selector).value); // Remove empty trailing params.
...
/*!************************************!*\
  !*** ./assets/js/relationships.js ***!
  \************************************/
/*! exports provided: Relationships */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Relationships", function() { return Relationships; });
/* harmony import */ var _inserter_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./inserter.js */ "./assets/js/inserter.js");
...
const Relationships = () => {
  ...
  useEffect(() => {
    const fetchRelationships = async () => {
      let response = await fetch(`${i18n.rest_url}mbv/relationships`, {
        headers: {
          'X-WP-Nonce': i18n.rest_nonce
        }
      });
      ...
      if (!response.code) {
        setRelationships(Object.values(response));
      }
    };

    fetchRelationships();
  }, []);
  return relationships.map((relationship, index) => /*#__PURE__*/React.createElement(Relationship, {
    key: index,
...
const Relationship = ({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "mbv-inserter__heading",
    title: i18n.relationship
  }, relationship.id, " ", /*#__PURE__*/React.createElement("span", {
    ...
    id: relationship.id,
    side: "to",
    settings: relationship.to,
    label: relationship.from.meta_box.title
  }), /*#__PURE__*/React.createElement(Side, {
    id: relationship.id,
    side: "from",
    settings: relationship.from,
    label: relationship.to.meta_box.title
  })));
};
...
const Side = ({
  ...
  const insertToEditor = e => {
    // Bypass all handlers from inserter.js.
    e.stopPropagation();
    let relationship = `relationships.${id}`,
        before = '';

    if (Object(_inserter_js__WEBPACK_IMPORTED_MODULE_0__["hasSpecialChars"])(id)) {
      before = `{% set relationship = attribute( relationships, '${id}' ) %}\n`;
      relationship = 'relationship';
    }

    let text = '';
    text += `{% for ${settings.object_type} in ${relationship}.${side} %}`;
    text += '\n\tINSERT FIELDS HERE';
    text += '\n{% endfor %}';
    Object(_inserter_js__WEBPACK_IMPORTED_MODULE_0__["insertTextAtCursor"])(`${before}${text}`);
  };
  ...
  if ('post' === object_type) {
    type = settings.field.post_type;
  } else if ('term' === object_type) {
    type = settings.taxonomy;
    text = i18n.taxonomy;
  ...
  label = label + ('user' === object_type ? ` (${text})` : ` (${text}: ${type})`);
  return /*#__PURE__*/React.createElement("li", {
    className: "mbv-inserter__field",
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _tabs_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./tabs.js */ "./assets/js/tabs.js");
...
const noResults = new Toggler('.mbv-inserter__no-results'),
      tabsNav = new Toggler('.mbv-panel .mbv-tabs__nav');

const search = e => {
  const fieldTabs = new _tabs_js__WEBPACK_IMPORTED_MODULE_0__["default"]('.mbv-panel');
  const fields = [...document.querySelectorAll('.mbv-inserter__field')]; // Find fields.

  const term = e.target.value.toLowerCase();
  const foundFields = fields.filter(field => !term || field.textContent.toLowerCase().includes(term)); // Not found.
  ...
  tabsNav.show();
  fieldTabs.hideTabs();
  fieldTabs.deactivateTabs();
  fieldTabs.hidePanes();
  fields.forEach(field => field.classList.add('hidden')); // Show fields and corresponding tabs.

  foundFields.forEach(field => {
    field.classList.remove('hidden');
    fieldTabs.showTab(field.closest('.mbv-tabs__pane').dataset.tab);
  }); // Show first tab as active and first pane.

  const tab = foundFields[0].closest('.mbv-tabs__pane').dataset.tab;
  fieldTabs.activateTab(tab);
  fieldTabs.showPane(tab);
};

document.querySelector('.mbv-inserter__search').addEventListener('keyup', search);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
const show = (container, className = 'mbv-is-visible') => name => container.find(el => el.dataset.tab === name).classList.add(className);

const hideAll = (container, className = 'mbv-is-visible') => () => container.forEach(el => el.classList.remove(className));

class Tabs {
  constructor(selector, callback) {
    const container = document.querySelector(selector);
    this.nav = container.querySelector('.mbv-tabs__nav'), this.tabs = [...container.querySelectorAll('.mbv-tabs__tab')], this.panes = [...container.querySelectorAll('.mbv-tabs__pane')];
    this.clickHandle = this.clickHandle.bind(this);
    this.callback = callback;
    this.activateTab = show(this.tabs, 'mbv-is-active');
    this.deactivateTabs = hideAll(this.tabs, 'mbv-is-active');
    this.showTab = show(this.tabs);
    this.hideTabs = hideAll(this.tabs);
    this.showPane = show(this.panes);
    this.hidePanes = hideAll(this.panes);
  }

  bindEvents() {
    return document.addEventListener('click', this.clickHandle);
  }

  clickHandle(e) {
    if (!e.target.classList.contains('mbv-tabs__tab') || e.target.parentNode !== this.nav) {
      return;
    }
  ...
  showTarget(e) {
    ...
    this.hidePanes();
    this.showPane(e.target.dataset.tab);
  }
...
const Views = () => {
  ...
  useEffect(() => {
    const fetchViews = async () => {
      let response = await fetch(`${i18n.rest_url}mbv/views`, {
        headers: {
          'X-WP-Nonce': i18n.rest_nonce
        }
      });
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("ul", {
    className: "mbv-inserter__fields"
  }, views.map((view, index) => /*#__PURE__*/React.createElement(View, {
    key: index,
    name: view.post_name,
...
const View = ({
  ...
  const insertToEditor = e => {
    // Bypass all handlers from inserter.js.
    e.stopPropagation();
    Object(_inserter_js__WEBPACK_IMPORTED_MODULE_0__["insertTextAtCursor"])(`{% include '${name}' %}`);
  };
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return getAvatarText; });
function getAvatarText(modal, currentUser, indents) {
...
/***/ "./src/Fields/Background/inserter.js":
/*!*******************************************!*\
  !*** ./src/Fields/Background/inserter.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return getBackgroundText; });
function getBackgroundText(modal, currentField) {
...
/***/ "./src/Fields/Checkbox/inserter.js":
/*!*****************************************!*\
  !*** ./src/Fields/Checkbox/inserter.js ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return getCheckboxText; });
/* harmony import */ var _assets_js_params_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../assets/js/params.js */ "./assets/js/params.js");

function getCheckboxText(modal, currentField) {
  ...
  const params = Object(_assets_js_params_js__WEBPACK_IMPORTED_MODULE_0__["default"])(['#mbv-field-checkbox-checked', '#mbv-field-checkbox-unchecked']);
  return `{{ mb.checkbox( ${currentField.id}, ${params} ) }}`;
}

/***/ }),

/***/ "./src/Fields/Choice/inserter.js":
/*!***************************************!*\
  !*** ./src/Fields/Choice/inserter.js ***!
  \***************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return getChoiceText; });
function getChoiceText(modal, currentField) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return getDateText; });
function getDateText(modal, currentField) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return getFileText; });
function getFileText(modal, currentField, indents) {
  const output = modal.querySelector('#mbv-field-file-output').value;
  const file = currentField.id;
  return 'tag' === output ? `<a href="{{ ${file}.url }}">{{ ${file}.title }}</a>` : `{{ ${file}.${output} }}`;
}

/***/ }),

/***/ "./src/Fields/Image/inserter.js":
/*!**************************************!*\
  !*** ./src/Fields/Image/inserter.js ***!
  \**************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return getImageText; });
function getImageText(modal, currentField, indents) {
  ...
  return 'tag' === output ? `${prepend}<img src="{{ ${image}.url }}" width="{{ ${image}.width }}" height="{{ ${image}.height }}" alt="{{ ${image}.alt }}">` : `${prepend}{{ ${image}.${output} }}`;
}

/***/ }),

/***/ "./src/Fields/KeyValue/inserter.js":
/*!*****************************************!*\
  !*** ./src/Fields/KeyValue/inserter.js ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return getKeyValueText; });
function getKeyValueText(modal, currentField) {
  return `{{ ${currentField.id}.0 }}: {{ ${currentField.id}.1 }}`;
}

/***/ }),

/***/ "./src/Fields/Map/inserter.js":
/*!************************************!*\
  !*** ./src/Fields/Map/inserter.js ***!
  \************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return getMapText; });
/* harmony import */ var _assets_js_params_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../assets/js/params.js */ "./assets/js/params.js");

function getMapText(modal, currentField) {
  ...
  const params = Object(_assets_js_params_js__WEBPACK_IMPORTED_MODULE_0__["default"])(['#mbv-field-map-width', '#mbv-field-map-height', '#mbv-field-map-zoom', '#mbv-field-map-marker-icon', '#mbv-field-map-marker-title', '#mbv-field-map-info-window']);
  return `{{ mb.map( '${currentField.id}', ${params} ) }}`;
}

/***/ }),

/***/ "./src/Fields/Oembed/inserter.js":
/*!***************************************!*\
  !*** ./src/Fields/Oembed/inserter.js ***!
  \***************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return getOembedText; });
function getOembedText(modal, currentField) {
...
/***/ "./src/Fields/Pagination/inserter.js":
/*!*******************************************!*\
  !*** ./src/Fields/Pagination/inserter.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return getPaginationText; });
function getPaginationText(modal, currentField, indents) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return getPostText; });
/* harmony import */ var _assets_js_params_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../assets/js/params.js */ "./assets/js/params.js");

function getPostText(modal, currentField, indents) {
  ...
  if ('thumbnail' === output) {
    ...
    return 'tag' === thumbnailOutput ? `${prepend}<img src="{{ ${image}.url }}" width="{{ ${image}.width }}" height="{{ ${image}.height }}" alt="{{ ${image}.alt }}">` : `${prepend}{{ ${image}.${thumbnailOutput} }}`;
  }

  if ('terms' === output) {
    const params = Object(_assets_js_params_js__WEBPACK_IMPORTED_MODULE_0__["default"])(['#mbv-field-post-terms-taxonomy', '#mbv-field-post-terms-before', '#mbv-field-post-terms-separator', '#mbv-field-post-terms-after']);
...
/***/ "./src/Fields/Sidebar/inserter.js":
/*!****************************************!*\
  !*** ./src/Fields/Sidebar/inserter.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return getSidebarText; });
function getSidebarText(modal, currentField) {
...
/***/ "./src/Fields/Taxonomy/inserter.js":
/*!*****************************************!*\
  !*** ./src/Fields/Taxonomy/inserter.js ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return getTaxonomyText; });
function getTaxonomyText(modal, currentField, indents) {
  const output = modal.querySelector('#mbv-field-taxonomy-output').value;
  const term = currentField.id;
  return 'tag' === output ? `<a href="{{ ${term}.url }}">{{ ${term}.name }}</a>` : `{{ ${term}.${output} }}`;
}

/***/ }),

/***/ "./src/Fields/Terms/inserter.js":
/*!**************************************!*\
  !*** ./src/Fields/Terms/inserter.js ***!
  \**************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return getTermsText; });
/* harmony import */ var _assets_js_params_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../assets/js/params.js */ "./assets/js/params.js");

function getTermsText(modal, currentField, indents) {
  const params = Object(_assets_js_params_js__WEBPACK_IMPORTED_MODULE_0__["default"])(['#mbv-field-terms-taxonomy', '#mbv-field-terms-before', '#mbv-field-terms-separator', '#mbv-field-terms-after']);
  return `{{ mb.get_the_term_list( post.ID, ${params} ) }}`;
}

/***/ }),

/***/ "./src/Fields/User/inserter.js":
/*!*************************************!*\
  !*** ./src/Fields/User/inserter.js ***!
  \*************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return getUserText; });
function getUserText(modal, currentField, indents) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return getVideoText; });
function getVideoText(modal, currentField, indents) {
